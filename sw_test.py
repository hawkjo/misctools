...
def local_alignment(s1, s2, scoring_dict, sigma): # sigma is penalty for indels. Should be positive.
    ...
    #if max_paths[i,j] != max_paths.max(): sys.exit("Non-maximal start")
...
if __name__ == "__main__":
    ...
    print 'Longer than ',cutoff,max_alignment_score_above_cutoff(s1, s2, simple_base_compare_score, sigma,
            cutoff)

    import contaminants_cython
    print 'Longer than ',cutoff, contaminants_cython.max_alignment_score_above_cutoff(s1, s2, cutoff)
